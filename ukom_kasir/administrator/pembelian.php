                            ...
                            <div class="modal-content">
                                ...
                                <form action="proses_update_pembelian.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <input type="number" name="alamat" class="form-control" value="<?= $d['alamat']; ?>">
                                        </div>
                                    </div>
            ...
            <form action="proses_pembelian.php" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" required="pelanggan_id" value="<?= date("dmHis") ?>" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>Nama Pelanggan</label>
                        <input type="text" required="nama_pelanggan" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>No. Telepon</label>
                        <input type="number" required="nomor_telepon" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <input type="text" required="alamat" class="form-control">
                        <input type="hidden" required="tanggal_penjualan" value="<?= date("Y-m-d") ?>" class="form-control">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Keluar</button>
